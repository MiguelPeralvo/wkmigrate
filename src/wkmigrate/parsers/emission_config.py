...
class ExpressionContext(StrEnum):
    ...
    IF_CONDITION_LEFT = "if_condition_left"  # Extension: enables per-operand routing for condition_task.
    IF_CONDITION_RIGHT = "if_condition_right"  # Extension: enables per-operand routing for condition_task.
    SWITCH_ON = "switch_on"
