...
| E-TRIG-3 | Stronger warning when `runtimeState="Started"` + empty recurrence | N/A | distinct warning text flags ENABLED-but-unscheduled state | `test_translate_schedule_trigger_started_empty_recurrence_emits_stronger_warning` |
